...
![](media/edd2bc3be299b07a2a4b711273dcd91a.png)
...
![](media/e53264e3e6daa9dbfbd87e990fa9c1b6.png)
...
![](media/4cdf4982837f0ce5847226d3682b23fc.png)
...
![](media/b7e1ef6a87ca06a576e486c263d8c975.png)
...
Records can also have identifying codes, known as either records alias or index. For example, each record either begins with a record ID[^4] or contains a record ID and ends with a delimiter.
...
A logical record is a unit of data which have a logical relationship. A logical record may itself be a physical record (that is, be contained completely within one physical unit of data); one logical record may extend across several physical records.[^5]

[^5]: Logical record could be a collection. In case of NewLine Properties
...
[^6]: Encoding is the process of transforming a set of Unicode characters into a sequence of bytes. In contrast, decoding is the process of transforming a sequence of encoded bytes into a set of Unicode characters.
...
Used as identifier[^7] and isn’t duplicated in the project.

[^7]: No all special characters are permitted except for the underscore ('_').
...
**![](media/4bcf50d6649c257f7b18d0a81915775f.png)**
